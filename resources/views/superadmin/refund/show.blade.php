...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Detail Kebijakan Pengembalian Dana</h1>
</div>
...
<div class="container mt-5">
       ...
       <a href="/refund" class="btn btn-success"><span data-feather="arrow-left"></span>Kembali</a>
       <a href="/refund/{{ $data->id }}/edit" class="btn btn-warning"><span data-feather="edit"></span>Ubah</a>
