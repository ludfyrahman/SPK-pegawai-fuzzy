...
class DashboardPrivacyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('superadmin.privacy.index', [
            'data' => Privacy::all()
        ]);
    }
    ...
    {
        return view('superadmin.privacy.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/privacy')->with('success', 'Berhasil di tambahkan!');
    }
    ...
    public function show(Privacy $privacy)
    {
        ...
        // dd($privacy);
        return view('superadmin.privacy.show', [
            'data' => $privacy 
        ]);
    }
    ...
    {
        return view('superadmin.privacy.edit', [
            'privacy' => $privacy,
            'data' => $privacy::all()
        ]);
    }
    ...
    public function update(Request $request, Privacy $privacy)
    {
        ...
        return redirect('/privacy')->with('success', 'Berhasil di ubah!');
    }
    ...
    public function destroy(Privacy $privacy)
    {
        ...
        return redirect('/privacy')->with('success', 'Berhasil di hapus!');
